          ...
          <form onSubmit={handleSubmit} className="space-y-5">
                ...
                >
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className={`transition-all duration-200 ${errors.name ? "border-red-500 ring-1 ring-red-500" : "focus:border-primary focus:ring-1 focus:ring-primary"}`}
                    />
                    {errors.name && (
                      <motion.p
              ...
              {step === 3 && (
                ...
                >
                  <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-center space-x-2 rounded-lg border p-4 hover:bg-muted/50 transition-colors cursor-pointer group">
                        <RadioGroupItem value="worker" id="worker" />
                        <Label htmlFor="worker" className="font-normal cursor-pointer flex-1">
                          <div className="font-medium group-hover:text-primary transition-colors">Service Provider</div>
                      ...
                      <div className="flex items-center space-x-2 rounded-lg border p-4 hover:bg-muted/50 transition-colors cursor-pointer group">
                        ...
                        <Label htmlFor="client" className="font-normal cursor-pointer flex-1">
                          <div className="font-medium group-hover:text-primary transition-colors">Client</div>
                      ...
                      <div className="flex items-center space-x-2 rounded-lg border p-4 hover:bg-muted/50 transition-colors cursor-pointer group">
                        ...
                        <Label htmlFor="both" className="font-normal cursor-pointer flex-1">
                          <div className="font-medium group-hover:text-primary transition-colors">Both</div>
            ...
            <DialogFooter className="flex justify-between mt-6 gap-2">
              ...
              {step < 3 ? (
                ...
                <Button
                  type="submit"
                  className="ml-auto bg-gradient-to-r from-primary to-purple-500 hover:from-primary/90 hover:to-purple-500/90"
