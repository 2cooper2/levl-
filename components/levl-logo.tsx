    ...
    >
      <defs>
        <radialGradient id="levl-grad-0" cx="30%" cy="25%" r="85%" fx="25%" fy="20%">
          <stop offset="0%" stopColor="#F5E8FE" />
          <stop offset="8%" stopColor="#EDDAFB" />
          <stop offset="20%" stopColor="#DCB7F8" />
          <stop offset="35%" stopColor="#C388F4" />
          <stop offset="55%" stopColor="#8943C3" />
          <stop offset="78%" stopColor="#3D125F" />
          <stop offset="100%" stopColor="#150428" />
        </radialGradient>
        <radialGradient id="levl-grad-1" cx="30%" cy="25%" r="85%" fx="25%" fy="20%">
          <stop offset="0%" stopColor="#F8EEFE" />
          <stop offset="8%" stopColor="#F0DFFC" />
          <stop offset="20%" stopColor="#DDB9F8" />
          <stop offset="38%" stopColor="#C388F4" />
          <stop offset="58%" stopColor="#7F38B3" />
          <stop offset="80%" stopColor="#33094F" />
