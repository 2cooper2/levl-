            ...
            {isAuthenticated ? (
              <>
                ...
                <MobileLink
                  ...
                  className="flex items-center gap-2 rounded-lg px-3 py-2 text-white bg-gradient-to-r from-purple-600 to-purple-400 transition-all hover:from-purple-700 hover:to-purple-500"
                  onOpenChange={setOpen}
                >
