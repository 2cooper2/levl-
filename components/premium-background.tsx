...
export function PremiumBackground() {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 -z-20 bg-background opacity-90" />
      <div className="fixed inset-0 -z-20 bg-noise opacity-[0.03]" />

      {/* Gradient blobs that subtly move with mouse */}
      <div
