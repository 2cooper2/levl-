      ...
      <div className="h-full">
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 backdrop-blur-[8px] bg-gradient-to-br from-purple-400/50 to-purple-500/30 dark:from-purple-500/30 dark:to-purple-600/20 opacity-80"></div>
            ...
            {/* Enhanced reflective top highlight */}
            <div className="absolute top-0 left-0 right-0 h-1/3 bg-gradient-to-b from-white/60 via-white/30 to-transparent opacity-70 group-hover:opacity-90 transition-opacity duration-300"></div>
            ...
            {/* Content wrapper */}
            <div className="p-6 flex flex-col items-center justify-between text-center relative z-10 h-full">
              {/* Icon container */}
              <div className="relative rounded-full bg-gradient-to-br from-white/90 to-purple-200/80 p-4 shadow-lg overflow-hidden">
                {/* Icon top highlight */}
              ...
              {/* Explore button */}
              <div className="flex items-center justify-center space-x-1.5 text-sm font-medium text-white/90 bg-purple-500/30 hover:bg-purple-500/40 backdrop-blur-sm px-4 py-2 rounded-full border border-purple-400/30 transition-all duration-200">
                <span>Explore</span>
