      ...
      return (
        <div className="relative w-full h-full overflow-hidden flex items-center justify-center">
          ...
          <div className="absolute inset-0" style={{
            ...
            <div className="absolute inset-0" style={{
              backgroundImage: `radial-gradient(circle at 20% 30%, rgba(0,0,0,0.018) 1px, transparent 1px)`,
              backgroundSize: '12px 12px'
            }} />
            <div className="absolute top-0 left-0 right-0 h-[12%] bg-gradient-to-b from-black/5 to-transparent" />
          </div>

          {/* Wall mount plate — visible behind TV */}
          <div className="absolute left-1/2 -translate-x-1/2 top-[18%] w-[8%] h-[10%] z-10" style={{
            background: 'linear-gradient(180deg, #3d3d3d 0%, #2a2a2a 100%)',
            borderRadius: '4px',
            boxShadow: '0 2px 6px rgba(0,0,0,0.35)'
          }}>
            <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[6px] h-[6px] rounded-full" style={{ background: 'radial-gradient(circle at 35% 35%, #666 0%, #333 100%)' }} />
            <div className="absolute bottom-[20%] left-1/2 -translate-x-1/2 w-[6px] h-[6px] rounded-full" style={{ background: 'radial-gradient(circle at 35% 35%, #666 0%, #333 100%)' }} />
          </div>

          {/* TV — tilts forward and back via rotateX */}
          <motion.div
            className="absolute left-1/2 -translate-x-1/2 w-[84%] h-[54%] z-20"
            style={{ top: '15%', transformOrigin: 'top center', perspective: '400px' }}
            animate={{ rotateX: [-12, 10, -12] }}
            transition={{ duration: 3.5, repeat: Infinity, ease: 'easeInOut' }}
          >
            {/* TV chassis */}
            <div className="absolute inset-0 rounded-[4px]" style={{
              background: 'linear-gradient(180deg, #0d0d0d 0%, #000 100%)',
              boxShadow: '0 6px 22px rgba(0,0,0,0.45), 0 2px 8px rgba(0,0,0,0.3)'
            }}>
              {/* Ultra-thin bezel */}
              <div className="absolute inset-[3px] rounded-[3px]" style={{
                background: 'linear-gradient(180deg, #181818 0%, #0a0a0a 100%)'
              }}>
                {/* Screen */}
                <div className="absolute inset-[3px] rounded-[2px] overflow-hidden" style={{
                  background: 'linear-gradient(135deg, #1a2a4a 0%, #0f1829 50%, #0a1220 100%)'
                }}>
                  <motion.div
                    className="absolute inset-0"
                    animate={{ background: [
                      'linear-gradient(135deg, #1a2a4a 0%, #0f1829 100%)',
                      'linear-gradient(135deg, #2a3040 0%, #161e2e 100%)',
                      'linear-gradient(135deg, #1a2a4a 0%, #0f1829 100%)'
                    ]}}
                    transition={{ duration: 5, repeat: Infinity }}
                  />
                  {/* Screen content hints */}
                  <div className="absolute top-[12%] left-[8%] w-[28%] h-[8%] rounded-sm bg-white/10" />
                  <div className="absolute top-[12%] right-[8%] w-[12%] h-[8%] rounded-sm bg-white/08" />
                  <div className="absolute bottom-[18%] left-[8%] right-[8%] h-[35%] rounded-sm" style={{ background: 'rgba(60,100,160,0.12)' }} />
                  {/* Screen glare */}
                  <div className="absolute top-0 left-0 right-0 h-[18%]" style={{ background: 'linear-gradient(180deg, rgba(255,255,255,0.04) 0%, transparent 100%)' }} />
                </div>
              </div>
              {/* Power LED */}
              <motion.div
                className="absolute bottom-[5px] left-1/2 -translate-x-1/2 w-[5px] h-[5px] rounded-full"
                style={{ background: '#00dd00', boxShadow: '0 0 4px #00bb00' }}
          ...
          {/* Tilt angle arc indicators on right */}
          <div className="absolute right-[6%] top-[20%]">
            <motion.svg width="38" height="58" viewBox="0 0 38 58"
              animate={{ opacity: [0.35, 0.75, 0.35] }}
              transition={{ duration: 2.5, repeat: Infinity }}
            >
              <path d="M19 10 L26 22 L21 22 L21 28 L17 28 L17 22 L12 22 Z" fill="#777" />
              <path d="M19 48 L26 36 L21 36 L21 30 L17 30 L17 36 L12 36 Z" fill="#777" />
              <path d="M8 29 Q 19 18, 30 29" fill="none" stroke="#999" strokeWidth="1.5" strokeDasharray="3,2" />
              <path d="M8 29 Q 19 40, 30 29" fill="none" stroke="#999" strokeWidth="1.5" strokeDasharray="3,2" />
            </motion.svg>
          </div>
    ...
    if (option === "Yes, hide all cables in wall") {
      return (
        <div className="relative w-full h-full overflow-hidden">
          {/* Wall background */}
          <div className="absolute inset-0" style={{
            background: 'linear-gradient(180deg, #f5f2ed 0%, #e8e4dd 60%, #d8d4cd 100%)'
          }}>
            <div className="absolute inset-0" style={{
              backgroundImage: `radial-gradient(circle at 30% 40%, rgba(0,0,0,0.015) 1px, transparent 1px)`,
              backgroundSize: '11px 11px'
          ...
          {/* TV mounted on wall — taller and more realistic */}
          <div className="absolute left-1/2 top-[2%] -translate-x-1/2 w-[80%] h-[50%]" style={{
            background: 'linear-gradient(180deg, #0d0d0d 0%, #000 100%)',
            borderRadius: '4px',
            boxShadow: '0 6px 20px rgba(0,0,0,0.4), 0 2px 8px rgba(0,0,0,0.25)'
          }}>
            <div className="absolute inset-[3px] rounded-[3px]" style={{ background: 'linear-gradient(180deg, #181818 0%, #0a0a0a 100%)' }}>
              <div className="absolute inset-[3px] rounded-[2px] overflow-hidden" style={{ background: 'linear-gradient(135deg, #1a2a4a 0%, #0f1829 50%, #0a1220 100%)' }}>
                <motion.div className="absolute inset-0"
                  animate={{ background: ['linear-gradient(135deg,#1a2a4a 0%,#0f1829 100%)','linear-gradient(135deg,#1e2e50 0%,#121c30 100%)','linear-gradient(135deg,#1a2a4a 0%,#0f1829 100%)'] }}
                  transition={{ duration: 5, repeat: Infinity }}
                />
                <div className="absolute top-[10%] left-[6%] w-[26%] h-[8%] rounded-sm bg-white/10" />
                <div className="absolute top-[10%] right-[6%] w-[14%] h-[8%] rounded-sm bg-white/08" />
                <div className="absolute bottom-[15%] left-[6%] right-[6%] h-[38%] rounded-sm" style={{ background: 'rgba(50,90,150,0.12)' }} />
                <div className="absolute top-0 left-0 right-0 h-[15%]" style={{ background: 'linear-gradient(180deg, rgba(255,255,255,0.03) 0%, transparent 100%)' }} />
              </div>
            </div>
            <motion.div className="absolute bottom-[5px] left-1/2 -translate-x-1/2 w-[5px] h-[5px] rounded-full"
              style={{ background: '#00cc00', boxShadow: '0 0 4px #00aa00' }}
              animate={{ opacity: [1, 0.4, 1] }} transition={{ duration: 2.5, repeat: Infinity }}
            />
          </div>

          {/* Wall cutaway cross-section showing hidden cables */}
          <div className="absolute left-[38%] top-[53%] w-[24%] h-[33%] rounded-[2px]" style={{
            ...
            <div className="absolute inset-[8%] rounded-sm" style={{ background: 'linear-gradient(180deg, #3a3530 0%, #2a2520 100%)' }}>
              <div className="absolute left-0 top-0 bottom-0 w-[18%]" style={{ background: 'linear-gradient(90deg, #8b7355 0%, #a08565 50%, #8b7355 100%)' }} />
              <div className="absolute right-0 top-0 bottom-0 w-[18%]" style={{ background: 'linear-gradient(90deg, #8b7355 0%, #a08565 50%, #8b7355 100%)' }} />
              <motion.div className="absolute left-1/2 top-[5%] -translate-x-1/2 w-[3px]"
                style={{ height: '90%', background: 'repeating-linear-gradient(180deg, #4ade80 0px, #4ade80 4px, transparent 4px, transparent 8px)' }}
          ...
          {/* Floor strip */}
          <div className="absolute bottom-0 left-0 right-0 h-[10%]" style={{ background: 'linear-gradient(180deg, transparent 0%, rgba(130,115,95,0.2) 100%)' }} />

          {/* Wall outlet — near floor level */}
          <div className="absolute left-1/2 bottom-[1%] -translate-x-1/2 w-[13%] h-[9%] rounded-[2px]" style={{
            background: 'linear-gradient(180deg, #f8f8f6 0%, #e4e4e0 100%)',
            boxShadow: '0 1px 4px rgba(0,0,0,0.18), inset 0 1px 1px rgba(255,255,255,0.8)'
          }}>
            <div className="absolute inset-[10%] rounded-[1px] border border-gray-300/50" />
            <div className="absolute top-[28%] left-[22%] w-[16%] h-[26%] rounded-sm bg-[#2a2a2a]" />
            <div className="absolute top-[28%] right-[22%] w-[16%] h-[26%] rounded-sm bg-[#2a2a2a]" />
            <div className="absolute bottom-[22%] left-1/2 -translate-x-1/2 w-[18%] h-[14%] rounded-full bg-[#2a2a2a]" />
          </div>
        </div>
      )
    }
      ...
      return (
        <div className="relative w-full h-full overflow-hidden">
          ...
          <div className="absolute inset-0" style={{
            ...
            <div className="absolute inset-0" style={{
              backgroundImage: `radial-gradient(circle at 25% 35%, rgba(0,0,0,0.015) 1px, transparent 1px)`,
              backgroundSize: '11px 11px'
            }} />
          </div>
          ...
          {/* Cable cover raceway — grows from TV down to outlet */}
          <motion.div
            className="absolute left-1/2 -translate-x-1/2 w-[7%] rounded-[2px]"
            style={{
              top: '52%',
              background: 'linear-gradient(90deg, #e0ddd8 0%, #f2efe9 35%, #f8f6f2 50%, #f2efe9 65%, #e0ddd8 100%)',
              boxShadow: '1px 1px 3px rgba(0,0,0,0.12), -1px 0 2px rgba(255,255,255,0.6)',
              height: '36%',
              transformOrigin: 'top',
            }}
            initial={{ scaleY: 0 }}
      ...
      return (
        <div className="relative w-full h-full overflow-hidden">
          ...
          <div className="absolute inset-0" style={{
            ...
            <div className="absolute inset-0" style={{
              backgroundImage: `radial-gradient(circle at 35% 45%, rgba(0,0,0,0.015) 1px, transparent 1px)`,
              backgroundSize: '11px 11px'
            }} />
          </div>
          ...
          {/* Visible cables hanging loosely */}
          <svg className="absolute left-1/2 top-[52%] -translate-x-1/2 w-[45%] h-[36%]" viewBox="0 0 45 36" fill="none">
            <motion.path d="M16 0 Q 8 9, 17 18 Q 26 27, 15 36"
              stroke="#1a1a1a" strokeWidth="1.8" fill="none"
              initial={{ pathLength: 0 }} animate={{ pathLength: 1 }}
              transition={{ duration: 1.6, repeat: Infinity, repeatDelay: 0.6 }}
            />
            <motion.path d="M23 0 Q 31 8, 22 17 Q 13 26, 24 36"
              stroke="#444" strokeWidth="1.4" fill="none"
              initial={{ pathLength: 0 }} animate={{ pathLength: 1 }}
              transition={{ duration: 1.6, delay: 0.25, repeat: Infinity, repeatDelay: 0.6 }}
            />
            <motion.path d="M29 0 Q 35 10, 28 19 Q 21 28, 30 36"
              stroke="#666" strokeWidth="1.1" fill="none"
              initial={{ pathLength: 0 }} animate={{ pathLength: 1 }}
              transition={{ duration: 1.6, delay: 0.5, repeat: Infinity, repeatDelay: 0.6 }}
            />
          </svg>
