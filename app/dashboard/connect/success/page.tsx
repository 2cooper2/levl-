            ...
            <CardContent className="pt-6 space-y-6">
              <div className="bg-green-50 dark:bg-green-950/20 p-4 rounded-lg">
                <p className="text-center text-sm text-muted-foreground">
                  You can now receive payments for your services through our platform. We'll handle the payment
                  processing and transfer the funds directly to your account.
                </p>
              </div>
